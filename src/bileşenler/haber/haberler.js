...
function haberYapici(haber) {
  const articleYarat = document.createElement("div");
  articleYarat.classList.add("article");

  const h2Yarat = document.createElement("h2");
  h2Yarat.textContent = haber.baslik;
  articleYarat.appendChild(h2Yarat);

  const tarihYarat = document.createElement("p");
  tarihYarat.classList.add("tarih");
  tarihYarat.textContent = haber.tarih;
  articleYarat.appendChild(tarihYarat);

  const paragraf1 = document.createElement("p");
  paragraf1.textContent = haber.ilkParagraf;
  articleYarat.appendChild(paragraf1);

  const paragraf2 = document.createElement("p");
  paragraf2.textContent = haber.ikinciParagraf;
  articleYarat.appendChild(paragraf2);

  const paragraf3 = document.createElement("p");
  paragraf3.textContent = haber.ucuncuParagraf;
  articleYarat.appendChild(paragraf3);

  const expandButtonYarat = document.createElement("span");
  expandButtonYarat.classList.add("expandButton");
  expandButtonYarat.textContent = "+";

  expandButtonYarat.addEventListener("click", (event) => {
    const acikHaber = document.querySelector(".article-open");
    if (acikHaber != null) acikHaber.classList.remove("article-open");
    articleYarat.classList.toggle("article-open");
  });

  articleYarat.appendChild(expandButtonYarat);
  return articleYarat;
}
